data_path="/data/private/ly/new_clip_bidirect/70k_train_6k_vaild"
save_dir="/data/private/ly/CLIP/0627_combine/savedir"
tmp_save_dir="/data/private/ly/CLIP/0627_combine/tmp_save_dir"
tsb_dir="/data/private/ly/CLIP/0627_combine/tsb_dir"
...
CUDA_VISIBLE_DEVICES="6,7" torchrun --nproc_per_node=$n_gpu --master_port=$MASTER_PORT $(which unicore-train) $data_path --user-dir ./unimol --train-subset train --valid-subset valid \
