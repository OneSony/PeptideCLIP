...
save_dir="/data/private/ly/CLIP/0626_6k/savedir"
tmp_save_dir="/data/private/ly/CLIP/0626_6k/tmp_save_dir"
tsb_dir="/data/private/ly/CLIP/0626_6k/tsb_dir"
...
CUDA_VISIBLE_DEVICES="3" torchrun --nproc_per_node=$n_gpu --master_port=$MASTER_PORT $(which unicore-train) $data_path --user-dir ./unimol --train-subset train --valid-subset valid \
